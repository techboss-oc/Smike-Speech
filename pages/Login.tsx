...
export const Login: React.FC<LoginProps> = ({ onNavigate }) => {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    // Simulate API call
    setTimeout(() => {
      if (email === 'admin@smikespeech.com' && password === 'admin123') {
        setIsLoading(false);
      ...
      setIsLoading(false);
      // For demo purposes, any other login goes to generator
      ...
      <div className="max-w-md w-full space-y-8 bg-slate-900 p-8 rounded-2xl border border-slate-800 shadow-2xl">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-slate-400">
            Sign in to your account to continue generating speech.
          </p>
        </div>
